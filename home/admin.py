...
from .models import Profile, PrintImage, PrintTemplate, AllEventsImage
...
admin.site.register(AllEventsImage, AuditAdmin)
admin.site.register(PrintImage, AuditAdmin)
